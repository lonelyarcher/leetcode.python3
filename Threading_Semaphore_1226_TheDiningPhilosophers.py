...
class DiningPhilosophers:
    ...
    def __init__(self):
        self.fork = [Semaphore(1) for _ in range(5)] # Semaphore is Object, so you can not [Semaphore(1)] * 4, which will generate only one object
        self.eating = Semaphore(4) # at most 4 people can try to acquire forks, 5 will generate deadlock
